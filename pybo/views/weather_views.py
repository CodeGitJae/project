...
def getWeather(date, address):
    global df3
    url = "http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst"
    api= "G34t4KEv8WaZXw02DVg%2BQLWymgFJ%2Fxrh%2BTJZM6Cz8kZse6qoFWUcAMQqL1xfiRmCeVinKefaKFLENM1naTfzgg%3D%3D"
...
def get_xy(address):  # 주소를 넣으면 x, y가 나옴.
    global df3
    ...
    if size == 1:
        ...
        cond3_na = df3["3단계"].str.contains(arr[2])
